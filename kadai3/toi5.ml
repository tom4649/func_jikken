...
module ToropMatrix = Matrix(Torop)
...
let a1=ToropMatrix.makematrix [[Torop.Int 1;Torop.Int 2;Torop.Int 3];[Torop.Int 4;Torop.Int 5;Torop.Int 6]] 
let a2=ToropMatrix.makematrix [[Torop.Int 1;Torop.Int 2];[Torop.Int 3;Torop.Int 4];[Torop.Int 5;Torop.Int 6]]  
let a3 =ToropMatrix.mul a1 a2
ToropMatrix.mul a1 a3
ToropMatrix.unit 4
ToropMatrix.pow a3 3

(*(*経路の例*)
let m=[[Torop.Int 0;Torop.Int 1;Torop.Int 5;Torop.Inf];
