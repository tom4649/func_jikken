...
expr:
  ...
  | LPAR expr CAMMA expr RPAR       { EPair($2,$4) }
...
factor_expr:
  | factor_expr TIMES minus_expr{ EMul($1,$3) }
  | factor_expr DIV minus_expr  { EDiv($1,$3) }
  | minus_expr                  { $1 }
;

minus_expr:
  |MINUS minus_expr { ESub(EConstInt(0),$2) }
  |app_expr { $1 }
;
